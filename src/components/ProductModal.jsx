      ...
      <div className="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto" >
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              <label className="block text-sm title text-gray-600 mb-1" htmlFor='title'>
                標題
              </label>
              <input
                type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm title text-gray-600 mb-1" htmlFor='category'>
                  分類
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm title text-gray-700 mb-1" htmlFor='unit'>
                  單位
                </label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm title text-gray-600 mb-1" htmlFor='origin_price'>
                  原價
                </label>
                <input
                  type="number"
                  ...
                  className={`w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary ${
                    errors.origin_price ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : ''
                  }`}
                  placeholder="請輸入原價"
                />
                {errors.origin_price && (
                  <p className="mt-1 text-sm text-red-500">{errors?.origin_price?.message}</p>
                )}
              </div>
              <div>
                <label className="block text-sm title text-gray-600 mb-1" htmlFor='price'>
                  售價
                </label>
                <input
                  type="number"
                  ...
                  {...register('price', {
                    ...
                    validate: (value, formValues) => 
                      parseInt(value) <= parseInt(formValues.origin_price) || '售價不能大於原價',
                  })}
            ...
            <div>
              <label className="block text-sm title text-gray-600 mb-1" htmlFor='description'>
                產品描述
              </label>
              <textarea
                name="description"
            ...
            <div>
              <label className="block text-sm title text-gray-600 mb-1" htmlFor='content'>
                說明內容
              </label>
              <textarea
                name="content"
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <label htmlFor="is_enabled" className="text-sm title text-gray-600">
                是否啟用
              </label>
            </div>
